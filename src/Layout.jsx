            ...
            <Navbar expand="lg" className={colorChange ? 'navbar colorChange' : 'navbar'} id='navigation'>
                <Container>
                    ...
                    <Navbar.Collapse className="collapse navbar-collapse" id="navbarScroll">
                        ...
                        <Button variant='warning' className='rounded-0 border-0 d-flex justify-content-evenly align-items-center cart' onClick={() => {window.location="/cart"}}>
                            ...
                            Cart
                            <Badge className='bg-success rounded-1 p-1 m-0 ms-2 cartbadge'>5</Badge>
                        </Button>
                    </Navbar.Collapse>
                </Container>
            </Navbar>

        ...
        <Container className='my-4 p-5 rounded-2 w-75'>
          <Row >
            <Col className="col-5 shadow p-4 text-center mx-auto rounded-2">
              ...
              <h3 className='mt-3 text-primary'>Contacts : <span className='text-warning fs-1'>45</span></h3>
            </Col>

            <Col className="col-5 shadow p-4 text-center mx-auto rounded-2">
              <i className='fa fa-user py-2 px-3 fs-2'></i>
              <h3 className='mt-3 text-primary'>Customer : <span className='text-warning fs-1'>65</span></h3>
            </Col>
